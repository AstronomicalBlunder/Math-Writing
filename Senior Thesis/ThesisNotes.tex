...
\begin{itemize}
    \item Almost everywhere in this text, we work with locally compact topological groups. In most cases we the groups are also assumed to be abelian. We use the abreviation "LCA group" in such cases.
...
\begin{corollary}
\label{cor: each component is closed subgrp of resprod}
